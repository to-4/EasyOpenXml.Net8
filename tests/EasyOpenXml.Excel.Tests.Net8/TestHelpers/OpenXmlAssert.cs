...
namespace EasyOpenXml.Excel.Tests.Net8.TestHelpers
{
    internal static class OpenXmlAssert
    {
        ...
        internal static WorksheetPart GetWorksheetPartByName(SpreadsheetDocument doc, string sheetName)
        {
        ...
        internal static Cell? GetCell(WorksheetPart wsPart, string a1)
        {
